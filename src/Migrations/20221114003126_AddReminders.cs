        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReminderSettingsUserId = table.Column<long>(type: "bigint", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Reminders", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Reminders_ReminderSettings_ReminderSettingsUserId",
                        column: x => x.ReminderSettingsUserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reminders_ReminderSettingsUserId",
                table: "Reminders",
                column: "ReminderSettingsUserId");
